...
class Cliente extends Conexion {
    ...
    public function modificarCliNatural($cambiarClave) {
        $this->dblink->beginTransaction();
        ...
        try {
            if($cambiarClave)
            {
                $sql = "update cliente set 
                            dni=:p_dni, 
                            apellido_paterno=:p_apepaterno, 
                            apellido_materno=:p_apematerno, 
                            nombres=:p_nombres, 
                            email= :p_email, 
                            telefono_fijo= :p_telfijo,
                            telefono_movil=:p_telmovil, 
    ...
    public function modificarCliJuridico($cambiarClave) {
        $this->dblink->beginTransaction();
    ...
    public function listarcliingresos($fecha1, $fecha2, $tipo, $top, $tc) {
        try {
            $sql = "select * from f_reporte_pedidos_clientes_ingresos(:p_fecha1, :p_fecha2, :p_tipo, :p_top, :p_tc)";
            $sentencia = $this->dblink->prepare($sql);

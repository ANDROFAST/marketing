...
function listar() {
    ...
    $.post
    (
        "../controlador/linea.listar.controlador.php",
        {
		...
		html += '&nbsp;&nbsp;';
		html += '<button type="button" class="btn btn-danger btn-xs" onclick="eliminar(' + item.codigo_linea + ')"><i class="fa fa-close"></i></button>';
		html += '</td>';
                html += '</tr>';
            });
...
$("#btnagregar").click(function(){
    ...
    $("#titulomodal").text("Agregar nueva Línea");
        ...
        (
            ...
            if (datosJSON.estado === 200){
                ...
                $.each(datosJSON.datos, function(i,item) {
                    ...
                    $("#txtdescrip").val( item.descripcion );

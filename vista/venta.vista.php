...
<html>
                        ...
                        <div class="box-body">
                              <div class="row">
                                  ...
                                  <div class="col-xs-2">
                                      <div class="form-group">
                                        <label>Serie</label>
					<input type="text" class="form-control input-sm" id="txtserie" name="txtserie" required="">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-xs-1">
                                      <div class="form-group">
                                        <label>IGV</label>
                                        <input type="text" readonly="" class="form-control input-sm" id="txtigv" name="txtigv" required="">
                                      </div>
                                  </div>
                              </div><!-- /row -->
                              <div class="row">
                              ...
                              <div class="row">                                  
                                  ...
                                  <div class="col-xs-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-sm" id="txtdireccionevento" name="txtdireccionevento">
                                      </div>
                                  </div>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-xs-12">
                                    <label>Agegar datos de pedido (Sólo si desea generar el comprobante de venta del pedido de un cliente)</label>
	...
	<script src="js/cargar-combos.venta.js" type="text/javascript"></script>
        <script src="js/venta_5.js" type="text/javascript"></script>                

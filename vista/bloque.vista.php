        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="text-bold text-black" style="font-size: 20px;">Mantenimiento de Bloques</h1>
                </section>      
              ...
              <div class="modal-dialog">
                ...
                <h4 class="modal-title" id="myModalLabel">Título de la ventana</h4>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-3">
                    <label> Orden:  <font color = "red">*</font> </label>
                        <p>
            ...
            <!-- FIN del formulario modal -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar" onclick="agregar()"><i class="fa fa-copy"></i> Agregar  nuevo Bloque</button>
                        </div>
                    </div>
                    <p>

                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <p><input type="text" class="form-control" name="txttelefonofijo" id="txttelefonofijo"
                                          placeholder="Teléfono Fijo" onkeypress=" return solonumeros(event)"
                                          maxlength="9" minlength="9" /></p>
                            </div>

                            <div class="col-xs-6">
                                <p><input type="text" class="form-control" name="txttelefonomovil" id="txttelefonomovil"
                                    placeholder="Teléfono Móvil" required="" onkeypress=" return solonumeros(event)"
                        ...
                        <div class="row">
                            <div class="col-xs-6 form-group has-feedback">
                                ...
                                <input type="password" class="form-control" name="txtclave" id="txtclave" required=""
                                       placeholder="Dejar en blanco para no cambiar la clave" onpaste="return false"
				  ...
				  <p>
				      ...
				      <select class="form-control input-sm" name="cbodistritomodal1" id="cbodistritomodal1" required="" >
                        ...
                        <div class="row">
                            <div class="col-xs-6 form-group has-feedback">
                                <!--<label>Contraseña * :</label>-->
                                <input type="password" class="form-control" name="txtclave1" id="txtclave1" 
                                       placeholder="Dejar en blanco para no cambiar la clave" onpaste="return false"
                                       data-parsley-trigger="keyup"/> 
                                <span class="fa fa-unlock-alt form-control-feedback right" aria-hidden="true"></span>
                            </div>
				  ...
				  <p>
				      ...
				      <select class="form-control input-sm" name="cbodistritomodal2" id="cbodistritomodal2" required="" >
                        ...
                        <div class="row">
                            <div class="col-xs-6 form-group has-feedback">
                                <!--<label>Contraseña * :</label>-->
                                <input type="password" class="form-control" name="txtclave2" id="txtclave2" 
                                       placeholder="Dejar en blanco para no cambiar la clave" onpaste="return false"
                                       data-parsley-trigger="keyup"/> 
                                <span class="fa fa-unlock-alt form-control-feedback right" aria-hidden="true"></span>
                            </div>

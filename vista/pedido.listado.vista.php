...
<html>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="text-bold text-black" style="font-size: 20px;">Registro de Pedidos</h1>
                </section>
                            ...
                            <form class="form-inline">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        &nbsp;
                                        <button type="button" class="btn btn-danger btn-sm" id="btnagregar">Agregar nuevo pedido</button>
                                    </div>
                                </div>
                            </form>
                        </div>
	...
	<!--JS-->
        <script src="js/pedido.listado.js" type="text/javascript"></script>

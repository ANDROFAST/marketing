        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="text-bold text-black" style="font-size: 20px;">Mantenimiento de Distrito</h1>
                </section>
            ...
            <!-- FIN del formulario modal -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar" onclick="agregar()"><i class="fa fa-copy"></i> Agregar nuevo Distrito</button>
                        </div>
                    </div>
                    <p>

...
<html>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="text-bold text-black" style="font-size: 20px;">Mantenimiento de Preguntas</h1>
                </section>
              ...
              <div class="modal-dialog">
                ...
                <h4 class="modal-title" id="myModalLabel">Título de la ventana</h4>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-6">
                    <label> Encuesta:  <font color = "red">*</font> </label>
                        <p>
                      ...
                      <div class="col-xs-6">
                    <label> Bloque:  <font color = "red">*</font>  </label>
                        <p>
                            <select class="form-control" name="cboprovincia" id="cboprovincia">
                  ...
                  <div class="row">
                    ...
                    <p><input type="text" name="txtcodigo" id="txtcodigo" class="form-control input-sm text-center text-bold" placeholder="" readonly=""></p>
                    </div>
                    <div class="col-xs-5">
                    <label> Orden Pregunta </label>
                        <p>
                         <input type="number"  name="txtorden" id="txtorden" class="form-control input-sm" value="1" min="0" max="1000" step="1"/>
                        </p>
                    </div>
                   <div class="col-xs-12">
                         <label> Pregunta: <font color = "red">*</font> </label>
                       <p>
            ...
            <!-- FIN del formulario modal -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar" onclick="agregar()"><i class="fa fa-copy"></i> Agregar nuevas preguntas</button>
                        </div>
                    </div>
                    <p>
  ...
  <?php
    ...
    <!--JS-->
    <script src="js/pregunta_1.js" type="text/javascript"></script>        

function listar(){
    $.post(
            "../controlador/encuesta.listar.controlador.php"
...
function agregar(){
    $("#myModalLabel").empty().append("Agregar nuevo encuesta");
   ...
   swal({
	...
	function(isConfirm){
            if (isConfirm){
                ...
                $.post(
                        "../controlador/encuesta.agregar.editar.controlador.php",
                         {
...
function editar(codigo){
    ...
    $.post(
            "../controlador/encuesta.leer-datos.controlador.php",
            {
                p_codigo : codigo
            }
            ).done(function(resultado){                
...
function eliminar(codigo){
	...
	function(isConfirm){
            if (isConfirm){
                    $.post(
                            "../controlador/encuesta.eliminar.controlador.php",
                            {
                                idEncuesta : codigo
                            }
                        ).done(function(resultado){

function listar(){
    $.post(
            "../controlador/provincia.listar.controlador.php"
...
function cargarComboDepartamento(){
    $("#cbodepartamento").load("../controlador/combo.departamento.controlador.php?modal=si");    
};
function agregar(){
    $("#myModalLabel").empty().append("Agregar nueva provincia");
   ...
   swal({
	...
	function(isConfirm){
            if (isConfirm){
                ...
                $.post(
                        "../controlador/provincia.agregar.editar.controlador.php",
                         {
...
function editar( codigodep , pro){
    ...
    $.post(
            "../controlador/provincia.leer-datos.controlador.php",
            {
                p_codigod : var1,
                p_codigop : var2
            }
                ...
                $("#txtcodigo").val(datos.codigo_provincia);
...
var var1,var2;
	...
	function(isConfirm){
            if (isConfirm){
                    $.post(
                            "../controlador/provincia.eliminar.controlador.php",
                            {
                                p_codigod : var1 , 
                                p_codigop : var2
                            }

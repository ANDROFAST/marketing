$(document).ready(function(){
    cargarComboDepartamentos("#cbodepartamento");
    cargarComboDepartamentos("#cbodepartamentoamodal");
    cargarComboDepartamentos("#cbodepartamentoamodal1");
    cargarComboDepartamentos("#cbodepartamentoamodal2");
    listar();
    cargarTipoCliente();
    readOnlyEstado();    
...
$("#cbodepartamento").change(function(){
    cargarComboProvincias("#cboprovincia", "#cbodepartamento");    
    cargarComboDistritos("#cbodistrito", "#cbodepartamento", "#cboprovincia");
    listar();
});
...
$("#cbodepartamentoamodal").change(function(){
    cargarComboProvincias("#cboprovinciamodal", "#cbodepartamentoamodal");    
    cargarComboDistritos("#cbodistritomodal", "#cbodepartamentoamodal", "#cboprovinciamodal");    
});

$("#cbodepartamentoamodal1").change(function(){
    cargarComboProvincias("#cboprovinciamodal1", "#cbodepartamentoamodal1");
    cargarComboDistritos("#cbodistritomodal1", "#cbodepartamentoamodal1", "#cboprovinciamodal1");
});

$("#cbodepartamentoamodal2").change(function(){
    cargarComboProvincias("#cboprovinciamodal2", "#cbodepartamentoamodal2");
    cargarComboDistritos("#cbodistritomodal2", "#cbodepartamentoamodal2", "#cboprovinciamodal2");
});
...
function cargarComboDepartamentos( cbo ){
    $.post
    (
...
function cargarComboProvincias( cbo, cbodep ){
    var prov = $(cbodep).val();
...
function cargarComboDistritos( cbo, cbodep, cboprov ){
...
//    $("#condiciones").val('1');
    $("#txtclave").attr('placeholder', "Ingrese una contraseña");
...
//    
    ...
    $("#txtclave1").val('');
    $("#txtclave1").attr('required', false);
    $("#txtclave1").attr('placeholder', "Dejar en blanco para no cambiar la clave");
...
//    
    ...
    $("#txtclave2").val('');
    $("#txtclave2").attr('required', false);
    $("#txtclave2").attr('placeholder', "Dejar en blanco para no cambiar la clave");

...
<html>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="text-bold text-black" style="font-size: 20px;">Mantenimiento de Encuestas</h1>
                </section>
            ...
            <div class="modal fade" id="myModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                ...
                <h4 class="modal-title" id="myModalLabel">Título de la ventana</h4>
                  ...
                  <div class="row">
                    <div class="col-xs-3">
                    <p>Código Encuesta<input type="text" name="txtcodigo" id="txtcodigo" class="form-control input-sm text-center text-bold" placeholder="" readonly=""></p>
                    </div>
                  </div>
                  <p>Nombre de la encuesta <font color = "red">*</font>
            ...
            <!-- FIN del formulario modal -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar" onclick="agregar()"><i class="fa fa-copy"></i> Agregar nueva Encuesta</button>
                        </div>
                    </div>
                    <p>
  ...
  <?php
    ...
    <!--JS-->
    <script src="js/encuesta_1.js" type="text/javascript"></script>

...
<html>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="text-bold text-black" style="font-size: 20px;">Reporte de Productos Top - Cantidad</h1>
                </section>
                    ...
                    <p>
                        <div class="box box-success">
                            <div class="box-body">
                                ...
                                <form class="form-inline" name="frmreporte" action="../controlador/pedido.reporte.controlador.php" method="post" target="_blank">    
                            <div class="row">
                                <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control input-sm" id="tipo_evento" name="tipo_evento" >
                                        </select>
                                    </div><!-- /.input group -->
                                </div>
                            </div>
  ...
  <?php
    ...
    ?>
      ...
      <!--JS-->
      <script src="../vista/js/tipo_evento.js"></script>
